...
public class FireSFXManager : MonoBehaviour
{
    ...
    public static FireSFXManager instance; // 다른 스크립트에서 이스크립트에있는 함수를 호출할때 쓰임 (Singleton)
    ...
    { 
        if (FireSFXManager.instance == null)  // 게임시작했을때 이 instance가 없을때
            FireSFXManager.instance = this;  // instance를 생성
    }
